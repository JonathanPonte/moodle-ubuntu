...
/**
 * Strings for component 'admin', language 'pt_br', version '4.2'.
 *
 * @package     admin
 * @category    string
...
$string['blockprotectblock'] = 'Instâncias protegidas do bloco {$a}';
...
$string['blockunprotectblock'] = 'Instâncias desprotegidas do bloco {$a}';
$string['blockunprotected'] = 'As instâncias do bloco {$a} não estão protegidas.';
...
$string['cliupgradecompletenomaintenanceupgrade'] = 'Para limpar os caches restantes após a atualização para o novo código:

   php admin/cli/purge_caches.php --muc
   php admin/cli/purge_caches.php --js
   php admin/cli/purge_caches.php --filter
   php admin/cli/purge_caches.php --outro

É recomendado realizar essas limpezas de forma isolada, com um intervalo entre os comandos, para reduzir picos de carga no servidor web.';
...
$string['cliupgrademaintenancenotrequired'] = 'Esta atualização NÃO habilita o modo de manutenção para os usuários.';
$string['cliupgrademaintenancerequired'] = 'Esta atualização HABILITARÁ o modo de manutenção para os usuários.';
...
$string['cliupgradesetlock'] = 'A atualização foi bloqueada apenas para a execução via CLI.';
$string['cliupgradeunsetlock'] = 'O bloqueio existente  de atualização de execução via CLI foi removido.';
$string['cliyesnoprompt'] = 'digite s (sim) ou n (não)';
$string['close'] = 'Fechar';
$string['cohort_customfield'] = 'Campos personalizados do Coorte';
...
$string['configservicespage'] = 'Digite a URL de uma página de serviços e suporte ou deixe em branco para vincular aos serviços do Moodle em moodle.com.';
...
$string['confirmdeletecomments'] = 'Você tem certeza que deseja excluir os comentários selecionado(s)?';
...
$string['coursecreationguide'] = 'URL do guia de criação do curso Moodle';
$string['coursecreationguide_help'] = 'Define o caminho para um guia de início rápido com vídeos curtos e dicas gerais para criar cursos. Um link para o guia é exibido na página Meus cursos quando não há cursos para mostrar. Apenas os usuários com permissão de criar cursos verão o link.';
...
$string['cron_keepalive'] = 'Continuar ativo';
...
$string['debugtemplateinfo'] = 'Mostrar informações do template';
$string['debugtemplateinfo_desc'] = 'Se habilitado, os templates usados para renderização são mostrados como comentários na página HTML. Use apenas para depuração temporária, pois produz erros de validação de HTML e pode interromper alguns scripts de página.';
...
$string['disableplugin'] = 'Desabilitar o plugin {$a}';
...
$string['enablepdfexportfont'] = 'Habilitar as fontes PDF';
$string['enablepdfexportfont_desc'] = 'Se o seu site tiver cursos em diferentes idiomas que precisam de outras fontes nos arquivos PDF gerados, você pode fornecer a opção de definir a fonte nas configurações do curso. Você precisa especificar as fontes disponíveis em $CFG->pdfexportfont no arquivo config.php.';
$string['enableplugin'] = 'Habilitar o plugin {$a}';
...
$string['enablesharingtomoodlenet'] = 'Habilitar compartilhamento para MoodleNet (externo)';
$string['enablesharingtomoodlenet_desc'] = 'Permitir que os usuários compartilhem o conteúdo do curso em uma instância configurada do MoodleNet, se tiverem permissão para isso.';
...
$string['plugin_disabled'] = 'Plugin {$a} foi desabilitado';
$string['plugin_enabled'] = 'Plugin {$a} foi habilitado';
...
$string['resetindentation_help'] = 'Isto removerá qualquer indentação previamente definida para todos os cursos do site em {$a->format}.';
$string['resetindentation_title'] = 'Redefinir a indentação no site todo?';
...
$string['servicespage'] = 'Link para Serviços e suporte';
