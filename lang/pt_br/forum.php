...
/**
 * Strings for component 'forum', language 'pt_br', version '4.2'.
 *
 * @package     forum
 * @category    string
...
$string['noguestpost'] = 'Somente usuários logados podem postar neste fórum.';
$string['noguestpost:title'] = 'Faça login para continuar';
