...
/**
 * Strings for component 'moodle', language 'pt_br', version '4.2'.
 *
 * @package     moodle
 * @category    string
...
$string['duplicatedsection'] = '{$a} (copiado)';
...
$string['moodlenet:cannotconnecttoserver'] = 'Não é possível conectar ao servidor MoodleNet';
$string['moodlenet:configoauthservice'] = 'Selecione um serviço MoodleNet OAuth 2 para habilitar o compartilhamento para o site da MoodleNet. Se o serviço não existir ainda, você precisa <a href="{$a}">criá-lo.</a>';
$string['moodlenet:eventresourceexported'] = 'Recurso exportado';
$string['moodlenet:gotomoodlenet'] = 'Vá para os rascunhos da MoodleNet';
$string['moodlenet:issuerisnotauthorized'] = 'O emissor de credenciais da MoodleNet não está autorizado';
$string['moodlenet:issuerisnotenabled'] = 'O emissor de credenciais da MoodleNet não está habilitado';
$string['moodlenet:issuerisnotset'] = 'O emissor de credenciais da MoodleNet não está definido na administração do site';
$string['moodlenet:outboundsettings'] = 'Configurações de saída da MoodleNet';
$string['moodlenet:packagingandsending'] = 'Empacotando seu arquivo e enviando para a MoodleNet';
$string['moodlenet:sharefailtext'] = 'Houve um erro ao compartilhar seu arquivo com a MoodleNet.<br>Por favor tente mais tarde.';
$string['moodlenet:sharefailtextwithsitesupport'] = 'Houve um erro ao compartilhar seu arquivo com a MoodleNet.<br>Por favor tente mais tarde ou <a href="{$a}"<contact site support</a>.';
$string['moodlenet:sharefailtitle'] = 'Algo deu errado';
$string['moodlenet:sharefilesizelimitexceeded'] = 'O tamanho do recurso sendo compartilhado ({$a->filesize} bytes) ultrapassa o limite de {$a->filesizelimit} bytes.';
$string['moodlenet:sharenotice'] = 'Você está compartilhando isto com a MoodleNet como {$a}';
$string['moodlenet:sharesuccesstext'] = 'Quase pronto! Visite seus rascunhos na MoodleNet para terminar de compartilhar seu conteúdo.';
$string['moodlenet:sharesuccesstitle'] = 'Salvo nos rascunhos do MoodleNet';
$string['moodlenet:sharetomoodlenet'] = 'Compartilhar no MoodleNet';
$string['moodlenet:sharetyperesource'] = 'recurso';
$string['moodlenet:sharinglargefile'] = 'Arquivos grandes podem levar algum tempo.';
$string['moodlenet:sharingstatus'] = 'Compartilhamento no MoodleNet';
$string['moodlenet:sharingto'] = 'Compartilhado com:';
...
$string['pluginmissingfromdisk'] = '{$a->name} (Faltando no disco)';
...
$string['wontrunfuturescheduledtask'] = 'Não será executada a tarefa que não falhou e está agendada para ser executada no futuro';
