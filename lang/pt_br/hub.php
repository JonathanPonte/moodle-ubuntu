...
/**
 * Strings for component 'hub', language 'pt_br', version '4.2'.
 *
 * @package     hub
 * @category    string
...
$string['coursesnodates'] = 'Número de cursos sem data de término definida ({$a})';
$string['coursesnumber'] = 'Número de cursos ({$a})';
$string['dbtype'] = 'Tipo de banco de dados ({$a})';
