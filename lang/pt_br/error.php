...
/**
 * Strings for component 'error', language 'pt_br', version '4.2'.
 *
 * @package     error
 * @category    string
...
$string['dndmaxbytes'] = 'O arquivo é muito grande. O tamanho máximo permitido é {$a->size}.';
$string['dndread'] = 'Erro ao ler o arquivo';
$string['dndunkownfile'] = 'Este tipo de arquivo não é suportado';
$string['dndupload'] = 'Ocorreu um erro desconhecido ao carregar o arquivo';
...
$string['editedpagenotfound'] = 'O sistema não pôde determinar a página em que você está. Atualize a página e tente novamente.';
...
$string['moodlenet:invalidshareformat'] = 'Formato de compartilhamento do MoodleNet inválido';
$string['moodlenet:usernotconfigured'] = 'Você não tem permissão para compartilhar conteúdo no MoodleNet ou sua conta está configurada incorretamente.';
