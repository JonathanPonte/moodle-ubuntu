...
/**
 * Strings for component 'group', language 'pt_br', version '4.2'.
 *
 * @package     group
 * @category    string
...
$string['participation'] = 'Mostrar grupo no menu suspenso para atividades no modo de grupo';
...
$string['visibility'] = 'Visibilidade do grupo';
$string['visibility_help'] = '* Visível para todos - todos os participantes do curso podem ver quem está no grupo
* Visível apenas para membros - os participantes do curso que não estão no grupo não podem visualizar o grupo ou seus membros
* Ver apenas a própria associação - um usuário pode ver que está no grupo, mas não pode ver outros membros do grupo
* Oculto - somente os professores podem visualizar o grupo e seus membros

Os usuários com o recurso de visualização de grupos ocultos sempre podem visualizar a participação no grupo.

Observe que você não pode alterar essa configuração se o grupo tiver membros.';
$string['visibilityall'] = 'Visível para todos';
$string['visibilitymembers'] = 'Visível somente para os membros';
