...
/**
 * Strings for component 'quiz', language 'pt_br', version '4.2'.
 *
 * @package     quiz
 * @category    string
...
$string['edit_slotdisplaynumber_hint'] = 'Editar número da questão (máximo de 16 caracteres)';
...
$string['eventquizattemptreopened'] = 'Tentativa de questionário reaberta';
...
$string['quiz:reopenattempts'] = 'Reabrir as tentativas de questionário nunca enviadas';
...
$string['reopenattemptareyousuremessage'] = 'Isso reabrirá a tentativa {$an->attempt number} de {$a->attempt user}.';
$string['reopenattemptareyousuretitle'] = 'Reabrir tentativa?';
$string['reopenedattemptwillbeinprogress'] = 'A tentativa permanecerá aberta e pode ser continuada.';
$string['reopenedattemptwillbeinprogressuntil'] = 'A tentativa permanecerá aberta e pode ser continuada e deverá ser enviada até {$a}, quando o questionário será fechado .';
$string['reopenedattemptwillbesubmitted'] = 'A tentativa reaberta será imediatamente submetida para avaliação.';
