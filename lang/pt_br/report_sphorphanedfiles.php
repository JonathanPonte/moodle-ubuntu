...
/**
 * Strings for component 'report_sphorphanedfiles', language 'pt_br', version '4.2'.
 *
...
$string['confighandleractivitiescore'] = 'Nem todas as <b>atividades nativas do moodle</b> suportam a descrição da introdução (por exemplo, rótulo).
    Esta lista separada por vírgulas da atividade nativa do moodle será verificada quanto a arquivos órfãos na descrição da introdução.
...
$string['confighandlermaterialscore'] = 'Nem todos os <b>recursos nativos do moodle</b> suportam a descrição da introdução.
    Esta lista separada por vírgulas dos recursos nativos do moodle será verificada quanto a arquivos órfãos na descrição da introdução.
